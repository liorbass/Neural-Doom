...
emcc -O3 -std=gnu11 \
    ...
    -s EXPORTED_FUNCTIONS="['_arm32_create','_arm32_free','_arm32_init','_arm32_load_binary_data','_arm32_run_steps','_arm32_step','_arm32_step_trace','_arm32_decode_prompt','_arm32_queue_key','_arm32_push_key','_arm32_clear_keys','_arm32_get_vram_ptr','_arm32_get_frame_rgba','_arm32_get_pc','_arm32_set_pc','_arm32_get_cpsr','_arm32_set_cpsr','_arm32_get_steps','_arm32_get_steps_double','_arm32_get_reg','_arm32_set_reg','_arm32_get_timer_ms','_arm32_get_keyboard','_arm32_is_halted','_arm32_probe_gs','_arm32_probe_gametic','_malloc','_free']" \
    -s EXPORTED_RUNTIME_METHODS="['ccall','cwrap','setValue','getValue','HEAPU8','HEAP32','UTF8ToString','stringToUTF8']" \
